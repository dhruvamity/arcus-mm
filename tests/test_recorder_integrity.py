"""Unit Tests for Recorder Integrity, Multi-Trade Dedup, and Sequence Gaps.

Fulfills Mandate Sections 24, 25 & 44:
- Invalidation on sequence gaps with INVALID_BOOK_INTERVAL markers
- Entire-frame trade deduplication across multi-trade arrays
- Snapshot resync restoring book validity
"""
...
class TestRecorderIntegrity(unittest.TestCase):
    def setUp(self):
        self.recorder = ArcusStreamRecorder(
            markets=["BTC-USD"],
            channels=["trades", "l2OrderbookUpdates"],
        )
