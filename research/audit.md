...
| **R-13** | MAJOR | Latency evidence below spec; misleading clock skew metric; inconsistent sample counts. | **FIXED** | [`latency/empirical_samples.json`](file:///Users/dhruv/Desktop/CodeWithD/arcus-mm/latency/empirical_samples.json) | Continuous empirical sampling implemented in `scripts/measure_latency.py`; clock skew dropped; canonical distribution established |
...
| **R-18** | MINOR | Calendar labeled weekend as US_LATE; 2026 early closes missing; MON_GAP not sourced. | **FIXED** | [`src/calendar.py`](file:///Users/dhruv/Desktop/CodeWithD/arcus-mm/src/calendar.py) | Fixed weekend session labeling, added 2026 early closes, sourced MON_GAP; verified in [`test_calendar_regimes`](file:///Users/dhruv/Desktop/CodeWithD/arcus-mm/tests/test_calendar_regimes.py) |
