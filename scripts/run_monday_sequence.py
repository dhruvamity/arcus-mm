...
def generate_live_paper_report(
    ...
    lines = [
        ...
        f"**Total Simulated Fills (All Models):** `{total_fills}`  ",
        f"**Unique Physical Match Events:** `{session_summary.get('unique_physical_matches', total_fills // 3 if total_fills else 0)}`  ",
