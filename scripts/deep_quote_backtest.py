...
def main():
    ...
    for m in a.markets.split(","):
        ...
        for d in [float(x) for x in a.depths.split(",")]:
            p = Params(depth_bps=d, requote_bps=a.requote, skew_bps=a.skew, daily_stop_usd=a.stop_usd, rate_limit=a.rate_limit,
    ...
    L = ["# Deep-quote replay on recorded L2 tape", "",
         ...
         f"skew {a.skew:g} bps, daily stop ${a.stop_usd:g}, "
