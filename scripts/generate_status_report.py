...
def generate_status_markdown(output_path: Path) -> None:
    ...
    md = [
        ...
        "|---|---|---|---|",
        f"| **Defect Ledger** | Total Findings | {total_findings} | V-01 through V-{total_findings} |",
        ...
        "## 4. Key Takeaway",
        "",
        f"All {total_findings} findings (V-01 through V-{total_findings}) from Mandate v3 are remediated and machine-attested with deterministic evidence. Gates G0, G1, G1b, and G2 have passed cleanly with explicit human sign-off. The pilot microstructure analysis (WS-G) and pre-registration protocol v3.1 draft (WS-H) are complete. The Monday operational sequence (12:00 UTC universe re-scan -> 12:30-16:30 UTC primary paper session) is armed and ready.",
        "",
    ]
